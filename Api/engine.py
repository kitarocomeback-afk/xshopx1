"""
Shopify Checkout Engine — V10
==============================
Async + curl_cffi (chrome120) + full GraphQL query.
Fixed: Price display, GENERIC_ERROR, timeout, retries.
...
class ShopifyEngine:
    ...
    async def init_checkout(self) -> bool:
        ...
        # ⭐ Try to extract checkout total from checkout page
    ...
    async def submit_payment(self) -> Dict:
        ...
        for attempt in range(MAX_ATTEMPTS):
            ...
            try:
                ...
                # ⭐ Try to extract checkoutTotal from response
                try:
