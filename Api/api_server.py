...
======================================
Drop-in replacement for https://newss-production-c390.up.railway.app/shopify
...
_stats = {
    ...
    "response_NO_PRODUCT: THROTTLED": 0,
    "response_PRICE_OVER_MAX": 0,
    "response_TOKENIZATION_FAILED": 0,
    "response_NO_SESSION_TOKEN": 0,
    "response_SITE_REQUIRES_LOGIN": 0,
    "response_NO_SHOPIFY_PAYMENTS_GATEWAY": 0,
    "response_SUBMIT_FAILED": 0,
    "response_GRAPHQL_ERROR": 0,
    "response_THROTTLED": 0,
    "response_TIMEOUT": 0,
...
app = FastAPI(
    ...
    version="2.0.0",
    description="Shopify card-check API — drop-in replacement.",
    docs_url=None,
    redoc_url=None,
)
...
<p>Shopify checkout engine. Drop-in replacement for newss-production-c390.up.railway.app/shopify</p>
...
<pre>{
  "Response": "ORDER_PLACED | 3DS_REQUIRED | CARD_DECLINED | CART_FAILED | ...",
...
def _run_check_sync(site: str, cc: str, proxy: Optional[str]) -> CheckResponse:
    ...
    # map CheckStatus -> Response string (သင့် API လို)
...
async def shopify(
    ...
    """
    Main check endpoint — drop-in replacement for
    https://newss-production-c390.up.railway.app/shopify
    """
...
if __name__ == "__main__":
    ...
    logger.info("CardCheckout API — port=%d threads=%d site_conc=%d cache_ttl=%d max_price=$%.2f",
